...
У кажого коммита (commit) есть своя контрольная сумма - хэш, это определенные набор цифр и букв. Хэш выводится в терминал после каждого коммита. С помощью команды 
